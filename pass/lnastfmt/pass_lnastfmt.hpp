...
protected:
  ...
  void process_node(Lnast* ln, const hhds::Tree_pos& it);
  ...
  Lnast_node duplicate_node(std::shared_ptr<Lnast>& lnastfmted, const std::shared_ptr<Lnast>& ln, const hhds::Tree_pos& it);
