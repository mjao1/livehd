...
protected:
  ...
  inline TSNode    get_first_child(const TSNode &, const char *) const;
  inline TSNode    get_first_child(const TSNode &, unsigned int) const;
  inline TSNode    get_first_child(const TSNode &) const;
