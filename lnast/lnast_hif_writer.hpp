...
protected:
  ...
  void write_hif_stmt() {
    switch (get_raw_ntype()) {
      ...
      CASE_LNAST_NTYPE( red_or           , tree       )
      CASE_LNAST_NTYPE( red_and          , tree       )
      CASE_LNAST_NTYPE( red_xor          , tree       )
      CASE_LNAST_NTYPE( log_and          , tree       )
      CASE_LNAST_NTYPE( log_or           , tree       )
      CASE_LNAST_NTYPE( log_not          , tree       )
